...
test.describe("Login page", () => {
  ...
  test("login form exists and shows auth disabled note", async ({ page }, testInfo) => {
    ...
    // Attempt to fill test credentials — form has no real handler yet, so URL should stay the same
