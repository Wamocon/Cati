...
export const unitMatrixCopy: Record<DashboardLocale, UnitMatrixCopy> = {
  ...
  de: {
    actions: {
      ...
      debtOpen: "Rückstandsstatus anzeigen",
    ...
    import: {
      ...
      modelDescription: "Jeder Datensatz verbindet Block, Etage, Wohnung, Eigentümer, Bewohner, Rückstand, Kaution, Zugang und Service.",
    ...
    labels: {
      ...
      payment: { clear: "Ausgeglichen", legal: "Juristische Prüfung", minor_debt: "Geringer Rückstand", overdue: "Überfällig" },
    ...
    live: {
      ...
      description: "Block, Etage, Wohnung, Eigentümer, Bewohner, Rückstand, Service und Importdaten werden in einer Operationsansicht geführt. Jede Aktion wird mit Berechtigungs- und Auditkontext protokolliert.",
    ...
    metrics: {
      debtHelper: "Konten mit Rückstand",
      debtLabel: "Gesamtrückstand",
    ...
    summary: {
      ...
      blockSummaryDescription: "Preislistenstatus, Verkauf, Belegung und Rückstand je Block.",
...
const operationalValueCopy: Record<DashboardLocale, Record<string, string>> = {
  en: {
    ...
    "Organizasyon Yöneticisi": "Organization Manager",
    "Site Yöneticisi": "Site Manager",
    "Muhasebe Sorumlusu": "Accounting Officer",
    "Teknik - Ahmet": "Technical - Ahmet",
    "Demo Malik": "Demo Owner",
    "Demo Kiracı": "Demo Tenant",
  ...
  tr: {
    ...
    "Organizasyon Yöneticisi": "Organizasyon Yöneticisi",
    "Site Yöneticisi": "Site Yöneticisi",
    "Muhasebe Sorumlusu": "Muhasebe Sorumlusu",
    "Teknik - Ahmet": "Teknik - Ahmet",
    "Demo Malik": "Demo Malik",
    "Demo Kiracı": "Demo Kiracı",
  ...
  de: {
    ...
    "Organizasyon Yöneticisi": "Organisationsmanager",
    "Site Yöneticisi": "Standortmanager",
    "Muhasebe Sorumlusu": "Buchhaltungsverantwortlicher",
    "Teknik - Ahmet": "Technik - Ahmet",
    "Demo Malik": "Demo-Eigentümer",
    "Demo Kiracı": "Demo-Mieter",
  ...
  ru: {
    ...
    "Organizasyon Yöneticisi": "Менеджер организации",
    "Site Yöneticisi": "Управляющий объектом",
    "Muhasebe Sorumlusu": "Бухгалтер",
    "Teknik - Ahmet": "Техник - Ахмет",
    "Demo Malik": "Демо-владелец",
    "Demo Kiracı": "Демо-арендатор",
