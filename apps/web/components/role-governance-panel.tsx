...
const governanceCopy: Record<SupportedLocale, GovernanceCopy> = {
  tr: {
    ...
    siteBody: "Site yöneticisi için site sınırı, operasyon rolleri ve insan onayı gerektiren işlemler açıkça ayrılır.",
    ...
    rolesTitle: "Tanımlı iş rolleri",
    rolesBody: "Sistemde atanabilen altı rol ve fiili izin kapsamları.",
    ...
    authority: {
      ...
      property_manager: "Site yöneticisi",
    ...
    controls: {
      permission_visibility: { title: "İzin görünürlüğü", detail: "Geçerli rol, modül ve aksiyon kapsamı doğrulanmış sistem bağlantısı üzerinden okunur." },
      role_assignment: { title: "Rol atama", detail: "Rol değişiklikleri yeniden kimlik doğrulama, gerekçe ve değiştirilemez denetim kaydı gerektirir." },
      site_assignment: { title: "Site ve ekip atama", detail: "Personel ve site yöneticisi kapsamı site ilişkisiyle ve onaylı iş akışıyla sınırlandırılmalıdır." },
    ...
    personas: {
      platform_super_admin: { title: "Platform süper yöneticisi", detail: "Organizasyon rolü değildir; ayrı kimlik, ayrı oturum ve gerekçeli acil erişim ile denetim kaydı gerektiren korumalı platform kapsamıdır." },
      organization_admin: { title: "Organizasyon yöneticisi", detail: "Admin temel rolüyle yalnızca atanmış şirket içinde kullanıcı, politika, denetim kaydı ve sağlayıcı görünürlüğü sağlar." },
      property_manager: { title: "Site yöneticisi", detail: "Manager temel rolüyle atanmış sitedeki servis, rezervasyon, ekip, SLA ve günlük riskleri yönetir." },
      ...
      public_intake: { title: "Misafir / kamu girişi", detail: "Kimliksiz talep açma aktif değildir; güvenli başvuru kanalı ayrıca oran sınırlama ve doğrulama gerektirir." },
    },
  },
  en: {
    ...
    rolesTitle: "Standard business roles",
    rolesBody: "The six assignable business roles and their effective permission scope.",
    ...
    controls: {
      permission_visibility: { title: "Permission visibility", detail: "The effective role, module, and action scope is read from a verified, authenticated system of record." },
    ...
    personas: {
      platform_super_admin: { title: "Platform super-admin", detail: "Not an organization role; a protected platform scope requiring separate identity, session, justified emergency-access approval, and an audit trail." },
  ...
  de: {
    ...
    rolesTitle: "Standard-Geschäftsrollen",
    rolesBody: "Die sechs zuweisbaren Geschäftsrollen mit ihrem wirksamen Berechtigungsumfang.",
    ...
    controls: {
      permission_visibility: { title: "Berechtigungstransparenz", detail: "Wirksame Rollen-, Modul- und Aktionsrechte werden über eine authentifizierte, gesicherte Systemverbindung gelesen." },
    ...
    personas: {
      platform_super_admin: { title: "Plattform-Superadmin", detail: "Keine Organisationsrolle; geschützter Plattformumfang mit separater Identität, Sitzung, begründeter Notfallfreigabe und Audit." },
  ...
  ru: {
    ...
    siteBody: "Явно разделяет границы объекта для управляющего объектом, операционные роли и действия с обязательным подтверждением человека.",
    ...
    rolesTitle: "Стандартные бизнес-роли",
    rolesBody: "Шесть назначаемых бизнес-ролей и их фактические разрешения.",
    ...
    authority: { organization_administrator: "Администратор организации", property_manager: "Управляющий объектом", finance_controller: "Финансовый контролер", field_operator: "Полевой сотрудник", unit_owner: "Собственник помещения", unit_tenant: "Авторизованный арендатор", guest_visitor: "Гость", service_vendor: "Поставщик услуг", managed_dependent: "Управляемый (детский) аккаунт" },
    ...
    controls: {
      permission_visibility: { title: "Прозрачность разрешений", detail: "Действующие роли, модули и действия читаются через проверенное авторизованное подключение." },
      ...
      site_assignment: { title: "Назначение объекта и команды", detail: "Полномочия персонала и управляющего объектом должны ограничиваться связью с объектом и согласованным процессом." },
    ...
    personas: {
      platform_super_admin: { title: "Суперадмин платформы", detail: "Не является ролью организации: защищенный контур с отдельной учетной записью, сессией, обоснованным экстренным согласованием и аудитом." },
      ...
      property_manager: { title: "Управляющий объектом", detail: "Управляет сервисом, бронированиями, командами, SLA и ежедневными рисками на назначенных объектах." },
