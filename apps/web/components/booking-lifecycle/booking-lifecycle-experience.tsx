...
const copy = {
  tr: {
    ...
    configure:
      "Yönetici önce Supabase bağlantısını ve 32 numaralı rezervasyon migration'ını tamamlamalıdır. Bu ekran sahte başarı göstermez.",
  ...
  en: {
    ...
    configure:
      "An administrator must connect Supabase and apply booking migration 32. This screen does not simulate success.",
  ...
  de: {
    ...
    configure:
      "Supabase und Migration 32 müssen zuerst freigegeben werden. Diese Ansicht simuliert keinen Erfolg.",
  ...
  ru: {
    ...
    configure:
      "Нужно подключить Supabase и применить миграцию 32. Экран не показывает фиктивный успех.",
