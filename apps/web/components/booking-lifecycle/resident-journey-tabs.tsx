...
const copy = {
  tr: { booking: "Rezervasyon", handover: "Taşınma ve teslim", sharing: "Takvim paylaşımı", nav: "Sakin yolculuğu bölümleri" },
  en: { booking: "Booking", handover: "Move and handover", sharing: "Calendar sharing", nav: "Resident journey sections" },
  de: { booking: "Buchung", handover: "Einzug und Übergabe", sharing: "Kalenderfreigabe", nav: "Bereiche der Bewohnerreise" },
  ru: { booking: "Бронирование", handover: "Заезд и передача", sharing: "Общий календарь", nav: "Разделы пути жителя" },
} as const
