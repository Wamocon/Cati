...
const copy = {
  tr: {
    ...
    body: "Kullanici ekleyin, kisi bilgilerini duzenleyin, birden fazla rol atayin, erisimi askiya alin veya bir kisiyi kaldirin. Yonetici rolu platform tarafindan verilir ve buradan atanamaz.",
    ...
    addRole: "Rol ekle",
    add: "Ekle",
    activate: "Erisimi geri ac",
    deactivate: "Erisimi askiya al",
    suspendHint: "Kisi simdilik giris yapamaz. Erisimi istediginiz zaman geri acabilirsiniz.",
    restoreHint: "Kisinin erisimini yeniden acar.",
    active: "Aktif",
    inactive: "Pasif",
    you: "Siz",
    protected: "Korumali",
    ...
    edit: "Ayrintilari duzenle",
    editTitle: "Kisiyi duzenle",
    language: "Dil",
    keepLanguage: "Dili degistirme",
    saveDetails: "Ayrintilari kaydet",
    detailsSaved: "Ayrintilar guncellendi.",
    signInEmail: "Giris e-postasi",
    emailNote: "Kisi bu adresle giris yapar. Degistirmek, giris seklini degistirir.",
    changeEmail: "Giris e-postasini degistir",
    emailSaved: "Giris e-postasi guncellendi.",
    remove: "Kisiyi kaldir",
    removeTitle: "Kisiyi kaldir",
    removeHint: "Kisiyi cikarir ve kisisel bilgilerini temizler. Gecmis saklanir.",
    removeWarning: "Bu kisi erisimini kaybeder ve kisisel bilgileri kaldirilir. Finans ve islem gecmisi kayitlarimizda saklanir.",
    removeReasonLabel: "Kaldirma nedeni (kayitlarimizda saklanir)",
    removeReasonHint: "Lutfen en az 10 karakter girin.",
    confirmRemove: "Kisiyi kaldir",
    removed: "Kisi kaldirildi ve kisisel bilgileri temizlendi.",
    cancel: "Vazgec",
    close: "Kapat",
