...
const playerCopy = {
  ...
  tr: {
    ...
    supabaseReady: "Videolar hazir",
    localFallback: "Yuklemeye hazir onizleme",
    pendingTitle: "Video dosyasi hazirlaniyor",
    pendingBody:
      "Bu kayit playlist icinde gorunur ve medya dosyasi hazir oldugunda oynatilabilir hale gelir.",
    chapters: "Bolumler",
    ...
    mute: "Sessiz",
    unmute: "Sesi ac",
    readyForUpload: "Video kutuphanesi",
  },
  ru: {
    library: "Video library",
    search: "Search videos",
    ...
    pendingTitle: "Video file is being prepared",
    pendingBody:
      "This item stays visible in the playlist and becomes playable as soon as the media file is available.",
    chapters: "Chapters",
    captionsOn: "Captions on",
    captionsOff: "Captions off",
    noCaptions: "No captions",
