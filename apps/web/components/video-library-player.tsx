...
const playerCopy = {
  en: {
    ...
    supabaseReady: "Supabase connected",
    localFallback: "Upload-ready preview",
    pendingTitle: "Video file pending in Supabase",
    pendingBody:
      "This item is listed so the 19-video library can be reviewed. Add the video_path, thumbnail_path and optional caption_tracks in Supabase to make it playable.",
    chapters: "Chapters",
    ...
    mute: "Mute",
    unmute: "Unmute",
    readyForUpload: "Supabase storage",
  },
  de: {
    library: "Videothek",
    ...
    videos: "Videos",
    nowPlaying: "Aktuell",
    supabaseReady: "Supabase verbunden",
    localFallback: "Upload-fertige Vorschau",
    pendingTitle: "Videodatei in Supabase fehlt",
    pendingBody:
      "Dieser Eintrag bleibt sichtbar, damit die 19 Videos geprueft werden koennen. video_path, thumbnail_path und caption_tracks in Supabase machen ihn abspielbar.",
    chapters: "Kapitel",
  ...
  tr: {
    library: "Video kutuphanesi",
    search: "Video ara",
    all: "Tumu",
    videos: "video",
    nowPlaying: "Oynatilan",
    supabaseReady: "Supabase bagli",
    localFallback: "Yuklemeye hazir onizleme",
    pendingTitle: "Supabase video dosyasi bekleniyor",
    pendingBody:
      "19 videoluk liste incelenebilsin diye bu kayit gorunur. Oynatmak icin Supabase icinde video_path, thumbnail_path ve caption_tracks ekleyin.",
    chapters: "Bolumler",
    captionsOn: "Altyazi acik",
    captionsOff: "Altyazi kapali",
    noCaptions: "Altyazi yok",
    speed: "Hiz",
    duration: "Sure",
    download: "Videoyu indir",
    fullscreen: "Tam ekran",
    pictureInPicture: "Resim icinde resim",
    replay: "Basa sar",
    back: "10 saniye geri",
    ...
    mute: "Sessiz",
    unmute: "Sesi ac",
    readyForUpload: "Supabase depolama",
  },
  ru: {
    library: "Video library",
    search: "Search videos",
    ...
    pendingTitle: "Video file pending in Supabase",
    pendingBody:
      "This item stays visible while the 19-video library is reviewed. Add video_path, thumbnail_path and caption_tracks in Supabase to make it playable.",
    chapters: "Chapters",
    captionsOn: "Captions on",
    captionsOff: "Captions off",
    noCaptions: "No captions",
