    ...
    return (
      <section className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-5 text-amber-800 dark:text-amber-200">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-base font-black">Bu sayfa rolünüz için kapalı</h1>
            <p className="mt-1 text-sm">
              Yetki modeli güvenlik nedeniyle varsayılan olarak erişimi reddeder. Sizin rolünüz için açık olan
