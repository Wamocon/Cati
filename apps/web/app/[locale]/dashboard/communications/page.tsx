...
const communicationsCopy = {
  ...
  de: {
    ...
    providerTitle: "Anbieterbereite Simulation",
    providerDescription: "SMS, E-Mail, Push und Portalnachrichten nutzen vorerst Demo-Warteschlangen; Anbieter-Adapter werden nach Verträgen und API-Schlüsseln aktiviert.",
    ...
    deliveryQueueDescription: "Zustellversuche, Anbietermodus und nächste Wiederholung werden vor Live-Anbindung verfolgt.",
    deliveryCount: "Zustellungen",
    templateLibraryTitle: "Mehrsprachige Vorlagenbibliothek",
    templateLibraryDescription: "TR-, EN-, DE- und RU-Vorlagen sind variablenbasiert, freigabebewusst und anbieterbereit.",
