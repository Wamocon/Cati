...
const demoCopy = {
  tr: {
    ...
    chapters: [
      ...
      { time: "12:30", title: "Mobil ve offline", text: "PWA, saha görevi, güvenli kuyruk ve tekrar deneme modeli.", route: "/dashboard/offline", status: "uat" },
      { time: "14:00", title: "Canlıya geçiş", text: "Supabase, provider anahtarları, UAT, eğitim ve launch kontrolü.", route: "/dashboard/settings", status: "guarded" },
    ],
    ...
    aiPoints: [
      ...
      "Üretimde log, RBAC ve denetim iziyle çalışır.",
    ],
    readinessTitle: "Demo öncesi dürüst hazırlık notu",
    readiness: [
      "Vercel üretim deployment hazır.",
      "Supabase bağlantısı canlı ortamda test edilir; gerçek müşteri verisi UAT onayıyla yüklenir.",
  ...
  en: {
    ...
    chapters: [
      ...
      { time: "12:30", title: "Mobile and offline", text: "PWA, field task, safe queue and retry model.", route: "/dashboard/offline", status: "uat" },
      { time: "14:00", title: "Go-live path", text: "Supabase, provider keys, UAT, training and launch control.", route: "/dashboard/settings", status: "guarded" },
    ],
    ...
    aiPoints: [
      ...
      "Runs with logs, RBAC and audit trail in production.",
    ],
    readinessTitle: "Honest pre-demo readiness note",
    readiness: [
      "Vercel production deployment is ready.",
      "Supabase connectivity is tested in the live environment; real customer data is loaded after UAT approval.",
  ...
  de: {
    ...
    chapters: [
      ...
      { time: "12:30", title: "Mobil und offline", text: "PWA, Außendienstaufgabe, sichere Queue und Retry-Modell.", route: "/dashboard/offline", status: "uat" },
      { time: "14:00", title: "Go-live-Pfad", text: "Supabase, Provider-Keys, UAT, Training und Launch-Kontrolle.", route: "/dashboard/settings", status: "guarded" },
    ],
    ...
    aiPoints: [
      ...
      "Läuft in Production mit Logs, RBAC und Audit-Trail.",
    ],
    readinessTitle: "Ehrlicher Hinweis vor der Demo",
    readiness: [
      "Das Vercel-Production-Deployment ist bereit.",
      "Supabase-Konnektivität wird in der Live-Umgebung geprüft; echte Kundendaten folgen nach UAT-Freigabe.",
  ...
  ru: {
    ...
    chapters: [
      ...
      { time: "12:30", title: "Mobile и offline", text: "PWA, field task, безопасная очередь и retry model.", route: "/dashboard/offline", status: "uat" },
      { time: "14:00", title: "Путь go-live", text: "Supabase, provider keys, UAT, training и launch control.", route: "/dashboard/settings", status: "guarded" },
    ],
    ...
    aiPoints: [
      ...
      "В production работает с logs, RBAC и audit trail.",
    ],
    readinessTitle: "Честная заметка перед демо",
    readiness: [
      "Vercel production deployment готов.",
      "Supabase connectivity проверяется в live-окружении; реальные данные клиента загружаются после UAT approval.",
