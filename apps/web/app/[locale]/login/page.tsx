...
const pageCopy = {
  tr: {
    ...
    roleIntro: "Bu alan sadece yetkili yerel ve test ortamlarında rol bazlı erişim kontrolü için kullanılır.",
    locked: "Rol profilleri bu ortamda kapalı.",
    authReady: "Güvenli giriş hazır.",
    ...
    close: "Kapat",
    googleNotice: "Google girişi üretim için hazırlanabilir. Canlıya almak için Google OAuth istemcisi ve sağlayıcı ayarı gerekir.",
  ...
  en: {
    ...
    roleIntro: "This area is only for authorized local and test environments to verify role-based access.",
    locked: "Role profiles are disabled in this environment.",
    authReady: "Secure sign-in is ready.",
    ...
    close: "Close",
    googleNotice: "Google sign-in can be activated for production after Google OAuth client and provider configuration.",
  ...
  de: {
    ...
    roleIntro: "Nur für autorisierte lokale und Testumgebungen zur Prüfung des rollenbasierten Zugriffs.",
    locked: "Rollenprofile sind in dieser Umgebung deaktiviert.",
    authReady: "Sichere Anmeldung ist bereit.",
    ...
    close: "Schließen",
    googleNotice: "Google Login kann für Produktion aktiviert werden, sobald Google OAuth Client und Anbieter konfiguriert sind.",
  ...
  ru: {
    ...
    roleIntro: "Только для авторизованных локальных и тестовых сред проверки ролевого доступа.",
    locked: "Ролевые профили отключены в этой среде.",
    authReady: "Безопасный вход готов.",
    ...
    close: "Закрыть",
    googleNotice: "Вход через Google можно включить после настройки Google OAuth Client и провайдера.",
