                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="mb-4 flex items-center gap-2">
                      ...
                      <h3 className="text-lg font-bold text-card-foreground">{data.name}</h3>
                    </div>
                      ...
                      <table className="w-full text-left text-sm">
                        <thead>
                          <tr className="border-b border-border/60">
                            {data.columns.map((col) => (
                              <th key={col} className="pr-4 pb-2 font-semibold text-card-foreground">
                                {col}
                              </th>
                            ))}
                          </tr>
                        ...
                        <tbody>
                          {data.rows.map((row, idx) => (
                            ...
                            >
                              {row.map((cell, cidx) => (
                                <td key={cidx} className="py-3 pr-4 text-muted-foreground">
                                  {cell}
                                </td>
                              ))}
                            </tr>
