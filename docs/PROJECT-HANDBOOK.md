...
|---|---|---|
| Public web app | Implemented as Next.js app with localized routes, including a New Level Premium public page for owner/tenant/staff requests, public reports and product concierge. | `apps/web/app/[locale]`, `apps/web/app/[locale]/new-level-premium`, `apps/web/messages/*.json` |
...
| Public intake and IDV | Confirm production identity-verification provider, KBS/legal retention period, abuse/rate-limit controls and human triage ownership before public launch. |
