...
- Mandatory UAT scenarios should block launch when critical or high defects remain unresolved.
...
```mermaid
flowchart TD
  A[Prepare UAT environment] --> B[Load realistic site data]
  B --> C[Confirm test users and roles]
  C --> D[Run mandatory UAT scripts]
...
<!-- DIAGRAM:qa-01-uat-workflow:END -->

---

## 4. Mandatory UAT Scenarios
...
- Mandatory UAT scenarios passed.
